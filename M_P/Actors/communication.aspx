<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="communication.aspx.cs" Inherits="M_P.Actors.communication" %>
...
<head runat="server">
    <meta charset="UTF-8" />
    <title>Admin Communication - Parul University</title>
...
<body>
    <form id="form1" runat="server">
        <header>
            <h1>Admin Communication - Parul University</h1>
        </header>
